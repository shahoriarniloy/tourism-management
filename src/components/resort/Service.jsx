    ...
    return (
        <section className='lg:mt-20 mt-16'>
            <div className="text-center mb-8 px-4">
                <TitleSection mainHeader={"PREMIUM SERVICES"} subHeader={"Your Every Hotel Need, Met with Our Diverse Services."} />
            </div>
            <div className="font-sans max-w-6xl max-md:max-w-md mx-auto">
                <div className="grid md:grid-cols-2 items-center md:gap-8 gap-6">
                    <div className="max-md:order-1 max-md:text-center z-50 relative">
                        <h2 className="text-gray-800 lg:text-6xl md:text-5xl text-3xl font-extrabold mb-4 md:!leading-[56px]"><span className="text-blue-600">Smart</span> Travelling with <span className="text-blue-600">Smart</span> Traveller</h2>
                        ...
                        <div className="mt-12">
                            <div className="grid sm:grid-cols-3 gap-4 items-center">
                                ...
                                <div className="flex flex-col items-center text-center">
                                    <h5 className="text-gray-800 font-bold text-xl mb-2">890k</h5>
                                    <p className="text-gray-600">Happy Client</p>
                                </div>
                                <div className="flex flex-col items-center text-center">
                                    <h5 className="text-gray-800 font-bold text-xl mb-2">250k</h5>
                    ...
                    <div className="lg:h-[500px] md:h-[500px] flex items-center relative max-md:before:hidden before:absolute before:bg-[#DEE2E5] before:h-[100%] before:w-[100%] before:right-0 before:z-0">
                        <Image height={600} width={600} src="https://readymadeui.com/team-3.webp" className="rounded-md lg:w-4/5 z-50 relative" alt="Dining Experience" />
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-4 z-50 relative md:px-4 max-md:mt-12 mb-12">
                    ...
                    <div className="bg-white p-6 shadow rounded-md">
                        ...
                        <p className="text-sm text-gray-600">Free Wi-Fi Connectivity </p>
                        <a href="javascript:void(0);" className="text-blue-600 font-bold inline-block text-sm hover:underline mt-4">Learn more</a>
                    </div>
                </div>
            </div>
